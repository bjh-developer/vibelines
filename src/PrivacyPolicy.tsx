            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 md:p-8 space-y-6 text-gray-300 mb-8">
              <section>
                ...
                <p className="text-sm md:text-base leading-relaxed">
                  When you connect your Spotify account, we access your liked
                  songs playlist information to analyse the emotional content of
                  your music. We do not store your personal information or
                  listening data permanently.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-sm md:text-base leading-relaxed">
                  Your music data is processed in real-time to generate
                  emotional analysis and create your personalised Vibelines
                  timeline. This data is used solely for providing the service
                  and is not shared with third parties. Emotions of songs are
                  stored in our database to optimise performance, but no
                  personal identifiers are kept.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-sm md:text-base leading-relaxed">
                  You can revoke access to your Spotify data at any time by
                  disconnecting your account. This will stop all data processing
                  and delete any stored information related to your account.{" "}
                  <a
